...
# Usamos el modelo google/gemma-2b-it (gratuito y open access)
HUGGINGFACE_API_URL = "https://api-inference.huggingface.co/models/google/gemma-2b-it"

app = FastAPI(title="API con FastAPI y Gemma-2B-IT")
...
@app.get("/")
async def root():
    return {"message": "API con FastAPI y Gemma-2B-IT funcionando"}
